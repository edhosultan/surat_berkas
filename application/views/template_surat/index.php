...
$suratdata->id)." class='btn btn-sm btn-info'><i class='fas fa-edit'></i> Edit</a>
...
<a href=".base_url('templatesurat/ surat_ajuan/' . $suratdata->id)." class='btn btn-sm btn-info'><i class='f
